...
//    }
    ...
    function insertSimpleItemAfterCurrent(coordinate) {
        console.log("insertSimpleItem called....");
...
//            }
        ...
        function recalcXPosition() {
            ...
            if (leftX >= toolInsets.leftEdgeBottomInset || rightX <= toolInsets.rightEdgeBottomInset ) {
...
//    }
    ...
    FlyViewInstrumentPanel {
        id:                         instrumentPanel
        anchors.margins:            _toolsMargin
//        anchors.top:                widgetlayer_enable.visible ? widgetlayer_enable.bottom : parent.top
        anchors.right:              parent.right
//        anchors.top:            HCToolBar.bottom
//        anchors.bottom:             multiVehiclePanelSelector.visible ? multiVehiclePanelSelector.bottom : parent.bottom
        width:                      _rightPanelWidth
        spacing:                    _toolsMargin
